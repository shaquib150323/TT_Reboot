        ...
        <div className='grid py-6 gap-8 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1'>
            <div className='food-card bg-red-500/15  rounded-xl flex flex-col cursor-pointer items-center p-5'>
                <div className='relative mb-3'>
                    <img src="https://images.unsplash.com/photo-1447195047884-0f014b0d9288?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8NXwzODc1OTE0fHxlbnwwfHx8fHw%3D" alt="" />
                ...
                <div className='flex gap-4 items-center'>
                    <p className='text-xl text-center font-bold text-[#f54748]'>Sundae
                    </p>
